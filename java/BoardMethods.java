...
public interface BoardMethods {
  ...
  // public abstract methods (note that we don't have 
  // to put public abstract in front
  // since methods declared in an interface are 
  ...
  // and we cannot write any computer instructions (code) here!!
