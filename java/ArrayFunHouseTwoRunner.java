...
public class ArrayFunHouseTwoRunner
{
	public static void main( String args[] )
	{
		...
		int[] four = {3, 6, 9, 12, 15, 18, 21, 23, 19, 17, 15, 13, 11, 10, 9, 6, 3, 2, 1, 0, 100};
		...
		updated = ArrayFunHouseTwo.getCountValuesBiggerThanX(four, 6, 15);
		System.out.println("first 6 values greater than 15  " + Arrays.toString(updated));
